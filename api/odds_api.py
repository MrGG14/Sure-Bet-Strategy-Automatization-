...
def sport_odds(sport, region = 'eu', markets= 'h2h', key = 'f8bf74f20a2de6a7c8ab3eaf8a52b312'):
    ...
    for match_odds in all_match_odds:
        ...
        for bookmaker_odd in match_odds:
            odd1 = (bookmaker_odd['markets'][0]['outcomes'][0]['name'], bookmaker_odd['markets'][0]['outcomes'][0]['price'], bookmaker_odd['title'])
            odd2 = (bookmaker_odd['markets'][0]['outcomes'][1]['name'], bookmaker_odd['markets'][0]['outcomes'][1]['price'], bookmaker_odd['title'])
            draw_odd = (bookmaker_odd['markets'][0]['outcomes'][2]['name'], bookmaker_odd['markets'][0]['outcomes'][2]['price'], bookmaker_odd['title'])
...
def main():   
    leagues = ['soccer_spain_la_liga', 'soccer_fifa_world_cup', 'soccer_australia_aleague', 'soccer_belgium_first_div', 'soccer_england_efl_cup', 'soccer_england_league1', 'soccer_england_league2', 'soccer_epl', 'soccer_france_ligue_one', 'soccer_germany_bundesliga', 'soccer_germany_bundesliga2', 'soccer_italy_serie_a', 'soccer_italy_serie_b', 'soccer_netherlands_eredivisie', 'soccer_poland_ekstraklasa', 'soccer_portugal_primeira_liga', 'soccer_spain_segunda_division', 'soccer_spl', 'soccer_uefa_champs_league', 'soccer_uefa_europa_conference_league', 'soccer_uefa_europa_league']
    ...
    for sure_match in odds_df.iterrows():
        ...
        msgs.append(msg)  
    for surebet in msgs:
        params = {"chat_id": "980282484", "text": surebet}
